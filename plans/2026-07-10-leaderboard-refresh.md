...
# Refreshable arena.ai ranking: weekly Action + in-app refresh button (HOOKLAB side)
...
5. `index.html`: a small "↻ Refresh" button (`#openrouterModelRefresh`) beside the Model
